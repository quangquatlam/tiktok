...
import SearchResult from '../../../Poper/SearchResult/SearchResult';
import AccountItem from '../../../Poper/AccountItem/AccountItem';
import Button from '../../../Button/Button';
import MenuItems from '../../../Poper/MenuItems/MenuItems';
            ...
            <div className={styles.wrapper}>
                <div className={styles.inner}>
                        ...
                        render={(attrs) => (
                            <SearchResult>
                                <div className={styles.searchResult} tabIndex="-1" {...attrs}>
                                    <h4 className={styles.title}>Tài khoản</h4>
                                    <AccountItem />
                                    <AccountItem />
                                    <AccountItem />
                                    <AccountItem />
                    ...
                    <div className={styles.action}>
                        ...
                        <Button children={'Đăng nhập'} primary></Button>
